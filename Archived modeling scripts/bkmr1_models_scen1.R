...
t1 = Sys.time()
bkmr_df = model_fnct(scenarios_start = 1, scenarios_end = 1, metals_count = 10, boot_count = 25, model_type = "BKMR1")
t2 = Sys.time()

# Output file
write.csv(bkmr_df, file = paste0("bkmr1_estimates_scen1_", currind, ".csv"))

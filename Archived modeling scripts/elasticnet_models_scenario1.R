...
t1 = Sys.time()
elasticnet_df = model_fnct(scenarios_start = 1, scenarios_end = 1, metals_count = 10, boot_count = 100, model_type = "elastic net")
t2 = Sys.time()

# Output file
write.csv(elasticnet_df, file = paste0("elasticnet_estimates_scen1_", currind, ".csv"))

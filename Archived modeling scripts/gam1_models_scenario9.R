...
t1 = Sys.time()
gam_df = model_fnct(scenarios_start = 9, scenarios_end = 9, metals_count = 10, boot_count = 100, model_type = "GAM")
t2 = Sys.time()

# Output file
write.csv(gam_df, file = paste0("gam1_estimates_scen9_", currind, ".csv"))

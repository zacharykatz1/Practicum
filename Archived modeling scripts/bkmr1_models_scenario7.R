...
t1 = Sys.time()
bkmr_df = model_fnct(scenarios_start = 7, scenarios_end = 7, metals_count = 10, boot_count = 100, model_type = "BKMR1")
t2 = Sys.time()

# Output file
write.csv(bkmr_df, file = paste0("bkmr1_estimates_scen7_", currind, ".csv"))

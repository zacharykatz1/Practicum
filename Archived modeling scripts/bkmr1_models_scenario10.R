...
t1 = Sys.time()
bkmr_df = model_fnct(scenarios_start = 10, scenarios_end = 10, metals_count = 10, boot_count = 100, model_type = "BKMR1")
t2 = Sys.time()

# Output file
write.csv(bkmr_df, file = paste0("bkmr1_estimates_scen10_", currind, ".csv"))

...
t1 = Sys.time()
linear_df = model_fnct(scenarios_start = 9, scenarios_end = 9, metals_count = 10, boot_count = 100, model_type = "linear")
t2 = Sys.time()

# Output file
write.csv(linear_df, file = paste0("linear_estimates_scen9_", currind, ".csv"))

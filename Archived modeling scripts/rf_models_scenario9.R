...
t1 = Sys.time()
rf_df = model_fnct(scenarios_start = 9, scenarios_end = 9, metals_count = 10, boot_count = 100, model_type = "Random Forest")
t2 = Sys.time()

# Output file
write.csv(rf_df, file = paste0("rf_estimates_scen9_", currind, ".csv"))

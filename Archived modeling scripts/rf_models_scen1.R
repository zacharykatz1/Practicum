...
t1 = Sys.time()
rf_df = model_fnct(scenarios_start = 1, scenarios_end = 1, metals_count = 10, boot_count = 25, model_type = "Random Forest")
t2 = Sys.time()

# Output file
write.csv(rf_df, file = paste0("rf_estimates_scen1_", currind, ".csv"))

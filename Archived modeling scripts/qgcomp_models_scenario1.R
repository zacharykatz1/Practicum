...
t1 = Sys.time()
qgcomp_df = model_fnct(scenarios_start = 1, scenarios_end = 1, metals_count = 10, boot_count = 100, model_type = "Quantile G-Computation")
t2 = Sys.time()

# Output file
write.csv(qgcomp_df, file = paste0("qgcomp_estimates_scen1_", currind, ".csv"))

...
t1 = Sys.time()
elasticnet_df = model_fnct(scenarios_start = 8, scenarios_end = 8, metals_count = 10, boot_count = 100, model_type = "elastic net")
t2 = Sys.time()

# Output file
write.csv(elasticnet_df, file = paste0("elasticnet_estimates_scen8_", currind, ".csv"))

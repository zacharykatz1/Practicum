...
t1 = Sys.time()
sl_df = model_fnct(scenarios_start = 3, scenarios_end = 3, metals_count = 10, boot_count = 100, model_type = "SuperLearner")
t2 = Sys.time()

# Output file
write.csv(sl_df, file = paste0("sl_estimates_scen3_", currind, ".csv"))

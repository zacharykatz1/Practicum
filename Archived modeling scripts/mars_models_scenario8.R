...
t1 = Sys.time()
mars_df = model_fnct(scenarios_start = 8, scenarios_end = 8, metals_count = 10, boot_count = 100, model_type = "MARS")
t2 = Sys.time()

# Output file
write.csv(mars_df, file = paste0("mars_estimates_scen8_", currind, ".csv"))

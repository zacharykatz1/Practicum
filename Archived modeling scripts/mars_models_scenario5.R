...
t1 = Sys.time()
mars_df = model_fnct(scenarios_start = 5, scenarios_end = 5, metals_count = 10, boot_count = 100, model_type = "MARS")
t2 = Sys.time()

# Output file
write.csv(mars_df, file = paste0("mars_estimates_scen5_", currind, ".csv"))

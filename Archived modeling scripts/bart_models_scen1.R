...
t1 = Sys.time()
bart_df = model_fnct(scenarios_start = 1, scenarios_end = 1, metals_count = 10, boot_count = 25, model_type = "BART")
t2 = Sys.time()

# Output file
write.csv(bart_df, file = paste0("bart_estimates_scen1_", currind, ".csv"))

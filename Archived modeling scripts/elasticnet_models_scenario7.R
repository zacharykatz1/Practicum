...
t1 = Sys.time()
elasticnet_df = model_fnct(scenarios_start = 7, scenarios_end = 7, metals_count = 10, boot_count = 100, model_type = "elastic net")
t2 = Sys.time()

# Output file
write.csv(elasticnet_df, file = paste0("elasticnet_estimates_scen7_", currind, ".csv"))

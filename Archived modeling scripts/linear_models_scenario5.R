...
t1 = Sys.time()
linear_df = model_fnct(scenarios_start = 5, scenarios_end = 5, metals_count = 10, boot_count = 100, model_type = "linear")
t2 = Sys.time()

# Output file
write.csv(linear_df, file = paste0("linear_estimates_scen5_", currind, ".csv"))

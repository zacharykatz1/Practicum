...
t1 = Sys.time()
cf_df = model_fnct(scenarios_start = 5, scenarios_end = 5, metals_count = 10, boot_count = 100, model_type = "Causal Forest")
t2 = Sys.time()

# Output file
write.csv(cf_df, file = paste0("cf_estimates_scen5_", currind, ".csv"))

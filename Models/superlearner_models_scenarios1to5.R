...
t1 = Sys.time()
superlearner_df = model_fnct(scenarios_start = 1, scenarios_end = 5, metals_count = 10, boot_count = 100, model_type = "SuperLearner")
t2 = Sys.time()

# Output file
write.csv(superlearner_df, file = paste0("superlearner_estimates_scens1to5_", currind, ".csv"))

...
t1 = Sys.time()
causal_forest_df = model_fnct(scenarios_start = 1, scenarios_end = 3, metals_count = 10, boot_count = 100, model_type = "Causal Forest")
t2 = Sys.time()

# Output file
write.csv(causal_forest_df, file = paste0("causal_forest_estimates_scens1to3_", currind, ".csv"))

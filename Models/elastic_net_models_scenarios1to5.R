...
t1 = Sys.time()
elastic_net_df = model_fnct(scenarios_start = 1, scenarios_end = 5, metals_count = 10, boot_count = 100, model_type = "elastic net")
t2 = Sys.time()

# Output file
write.csv(elastic_net_df, file = paste0("elastic_net_estimates_scens1to5_", currind, ".csv"))

...
t1 = Sys.time()
qgcomp_df = model_fnct(scenarios_start = 6, scenarios_end = 10, metals_count = 10, boot_count = 100, model_type = "Quantile G-Computation")
t2 = Sys.time()

# Output file
write.csv(qgcomp_df, file = paste0("qgcomp_estimates_scens6to10_", currind, ".csv"))

...
t1 = Sys.time()
gam1_df = model_fnct(scenarios_start = 1, scenarios_end = 5, metals_count = 10, boot_count = 100, model_type = "GAM")
t2 = Sys.time()

# Output file
write.csv(gam1_df, file = paste0("gam1_estimates_scens1to5_", currind, ".csv"))

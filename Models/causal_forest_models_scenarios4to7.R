...
t1 = Sys.time()
causal_forest_df = model_fnct(scenarios_start = 4, scenarios_end = 7, metals_count = 10, boot_count = 100, model_type = "Causal Forest")
t2 = Sys.time()

# Output file
write.csv(causal_forest_df, file = paste0("causal_forest_estimates_scens4to7_", currind, ".csv"))

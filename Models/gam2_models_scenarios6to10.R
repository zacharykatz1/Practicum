...
t1 = Sys.time()
gam2_df = model_fnct(scenarios_start = 6, scenarios_end = 10, metals_count = 10, boot_count = 100, model_type = "GAM2")
t2 = Sys.time()

# Output file
write.csv(gam2_df, file = paste0("gam2_estimates_scens6to10_", currind, ".csv"))

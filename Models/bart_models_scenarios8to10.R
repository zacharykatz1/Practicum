...
t1 = Sys.time()
bart_df = model_fnct(scenarios_start = 8, scenarios_end = 10, metals_count = 10, boot_count = 100, model_type = "BART")
t2 = Sys.time()

# Output file
write.csv(bart_df, file = paste0("bart_estimates_scens8to10_", currind, ".csv"))

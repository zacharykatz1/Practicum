...
t1 = Sys.time()
bart_df = model_fnct(scenarios_start = 4, scenarios_end = 7, metals_count = 10, boot_count = 100, model_type = "BART")
t2 = Sys.time()

# Output file
write.csv(bart_df, file = paste0("bart_estimates_scens4to7_", currind, ".csv"))

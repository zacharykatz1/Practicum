#!/bin/bash
#$ -cwd -l mem=15g,time=15:00:00 -S /bin/bash -N JOBsuperlearner1 -j y -t 1-400 -M zacharykatz1@gmail.com -m aes
...
Rscript superlearner_models_scenarios1to5.R $currind
~

...
t1 = Sys.time()
random_forest_df = model_fnct(scenarios_start = 8, scenarios_end = 10, metals_count = 10, boot_count = 100, model_type = "Random Forest")
t2 = Sys.time()

# Output file
write.csv(random_forest_df, file = paste0("random_forest_estimates_scens8to10_", currind, ".csv"))

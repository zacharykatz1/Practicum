#!/bin/bash
#$ -cwd -l mem=15g,time=30:00:00 -S /bin/bash -N JOBcausalforest1 -j y -t 1-400 -M zacharykatz1@gmail.com -m aes
...
Rscript causal_forest_models_scenarios1to3.R $currind
~

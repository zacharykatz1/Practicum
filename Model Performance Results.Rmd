...
model_performance = function(df){
  ...
  performance_summary = rows %>% 
    ...
    select(scenario, metal, mean_point_estimate, bias, relative_bias, variance_point_estimate, RMSE, coverage, power, avg_time)
...
all_performance = rbind(linear_performance, elastic_net_performance, mars_performance)

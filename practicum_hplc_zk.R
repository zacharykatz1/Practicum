...
# CHANGE THIS PATH once data is migrated to the cluster
simulated_data <- readRDS('/ifs/scratch/msph/biostat/zak2132/data/simulated_data.RDS')
true_effects <- readRDS('/ifs/scratch/msph/biostat/zak2132/data/true_effects.RDS')
true_effects_mixture <- readRDS('/ifs/scratch/msph/biostat/zak2132/data/true_effects_mixture.RDS')
